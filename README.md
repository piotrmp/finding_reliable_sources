...
The results of this study were described in the article *Countering Disinformation by Finding Reliable Sources: a Citation-Based Approach* (see the article as [conference proceedings](TODO) or [authors' version](https://home.ipipan.waw.pl/p.przybyla/bib/Learning_to_Cite_3_CR.pdf)) presented at the [IJCNN 2022](https://wcci2022.org) conference in Padoa, Italy. The datasets created for this work are published on Zenodo as [Wikipedia Complete Citation Corpus](https://doi.org/10.5281/zenodo.6539054) and [FRS Evaluation Datasets](https://doi.org/10.5281/zenodo.6539087).
